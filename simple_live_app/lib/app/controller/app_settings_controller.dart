...
class AppSettingsController extends GetxController {
  ...
  void onInit() {
    ...
    recordDir.value = LocalStorageService.instance
        .getValue(LocalStorageService.kRecordDir, "");
  ...
  /// 录制输出目录。空字符串表示用默认目录。
  var recordDir = "".obs;
  void setRecordDir(String e) {
    recordDir.value = e;
    LocalStorageService.instance.setValue(LocalStorageService.kRecordDir, e);
  }
